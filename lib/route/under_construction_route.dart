...
import '../page/under_construction_page.dart';
import '../shareable/navigator_helper.dart';
import '../shareable/route/page_builder_generator.dart';

final class UnderConstructionRoute with PageGenerator {
  const UnderConstructionRoute();

  static const String name = '/under-construction';
  ...
  WidgetBuilder generateBuilder(RouteSettings settings) =>
    (BuildContext context) => const UnderConstructionPage();
}

final class UnderConstructionNavigator {
  const UnderConstructionNavigator({
    this.navigator,
  });
